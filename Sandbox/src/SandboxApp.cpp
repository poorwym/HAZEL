...
public:
	...
	{ 
		...
		m_Shader = Hazel::Shader::Create("VertexColorTriangleShader", vertexSrc, fragmentSrc);
	...
	virtual void OnEvent(Hazel::Event& e) override
	{
		...
		// dispatcher.Dispatch<Hazel::WindowResizeEvent>(HAZEL_BIND_EVENT_FN(OnWindowResize));
	}
private:
